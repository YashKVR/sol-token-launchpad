...
export function TokenLaunchpad() {
    ...
    return <div style={{
        ...
        <input className='inputText' type='text' placeholder='Symbol' onChange={e => setSymbol(e.target.value)} /> <br />
        <input className='inputText' type='text' placeholder='Image URL' onChange={e => setUri(e.target.value)} /> <br />
